        ...
        <>
            <div id="albuns-inner-row" className="row">
                ...
                <div id="album-title" className="col d-flex flex-column justify-content-center align-items-start">
                    <a id="open-album-page" type="button" onClick={() => onAlbumClick(albumContent)}>
                        <h5>{albumContent.albumTitle}</h5>
                    </a>
                    <p>{albumContent.albumYear} - <a id="open-artist-page" type="button" onClick={() => onArtistClick(artistContent)}>{albumContent.albumAuthor}</a></p>
                </div>
            </div>  
        </>
    );
