...
function usePlaylistInfo({ playlistData, accessToken, trackLimit = 100, artistLimit = 50, offset = 0, market = 'US' }) {
    ...
    useEffect(() => {
        const fetchPlaylist = async () => {
            ...
            try {
                // Fetch the playlist tracks with a limit of 100 and a market parameter
                const res = await axios.get(`https://api.spotify.com/v1/playlists/${idPlaylist}/tracks`, {
                    ...
                    params: {
                        ...
                        offset: offset,  
                        market: market // Include the market parameter
                    },
                });
        ...
        fetchPlaylist();
    }, [idPlaylist, accessToken, trackLimit, artistLimit, offset, market]);
